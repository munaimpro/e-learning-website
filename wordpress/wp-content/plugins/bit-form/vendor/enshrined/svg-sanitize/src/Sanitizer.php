<?php
namespace BitCode\BitForm\enshrined\svgSanitize;

use BitCode\BitForm\enshrined\svgSanitize\data\AllowedAttributes;
use BitCode\BitForm\enshrined\svgSanitize\data\AllowedTags;
use BitCode\BitForm\enshrined\svgSanitize\data\AttributeInterface;
use BitCode\BitForm\enshrined\svgSanitize\data\TagInterface;
use BitCode\BitForm\enshrined\svgSanitize\data\XPath;
use BitCode\BitForm\enshrined\svgSanitize\ElementReference\Resolver;
...
class Sanitizer
{
    ...
    protected function cleanAttributesOnWhitelist(\DOMElement $element)
    {
        for ($x = $element->attributes->length - 1; $x >= 0; $x--) {
            ...
            /**
             * This is used for when a namespace BitCode\BitForm\isn't imported properly.
             * Such as xlink:href when the xlink namespace BitCode\BitForm\isn't imported.
